...
var ChartK = (function() {
    ...
    function ChartK(options) {
        ...
        this.container.className = this.container.className.replace(/valueview-container/g, "").trim();
        this.container.className = this.container.className + " valueview-container";
        // 图表加载完成事件
    ...
    function addFuQuan() {
        var authorityType = EMcookie.getCookie("valueview-authorityType") == null ? "" : EMcookie.getCookie("valueview-authorityType");
        ...
        if(this.options.authorityType === undefined){
            ...
            if(authorityType !== this.options.authorityType){
                ...
                EMcookie.setCookie("valueview-authorityType", this.options.authorityType, exp, "/");
            }
        }
    }
